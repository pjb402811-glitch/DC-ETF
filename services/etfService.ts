...
export const ALL_ETFS: Record<string, Etf> = {
  ...
  '414270': {
    ticker: '414270',
    name: 'ACE 글로벌자율주행액티브',
    desc: '글로벌 자율주행 및 전기차 관련 기업에 액티브 방식으로 투자하여 미래 모빌리티 산업의 고성장을 추구하는 ETF입니다.',
    pros: '전문가가 유망 기업을 직접 선정하여 시장 초과 수익을 추구하며, 미래 핵심 산업에 투자합니다.',
    cons: '액티브 운용에 따른 높은 보수, 기술 개발 및 상용화의 불확실성 리스크가 존재합니다.',
    yield: 0.002,
    growth: 0.13,
    color: 'yellow',
    risk: '높음',
